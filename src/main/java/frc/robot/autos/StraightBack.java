...
public class StraightBack extends SequentialCommandGroup {
  public StraightBack(Swerve s_Swerve, Limelight m_Limelight, Intake intake, Passthrough m_Passthrough, Shooter shooter){
    ...
    List.of(new Pose2d(0, 0, new Rotation2d(0)), 
    new Pose2d(-Units.feetToMeters(9), Units.feetToMeters(1), new Rotation2d(0))
    //,new Pose2d(0,0, new Rotation2d(0))
    ),    
    config);

    Trajectory goToStart = TrajectoryGenerator.generateTrajectory(
        List.of(new Pose2d(0, 0, new Rotation2d(0)), 
        new Pose2d(Units.feetToMeters(-3), -Units.feetToMeters(-2), new Rotation2d(0))
        //,new Pose2d(0,0, new Rotation2d(0))
        ),    
        config);
